...
status_bars = ttk.Label(
    window,
    text=
    "\t\t Surge Productions \t\t\t\t\t characters: 0 words: 0 \t\t\t\t Please Save Before You Run Your File - No Spaces\t\t"
)
...
def change_word(event=None):
    ...
    if editor.edit_modified():
        ...
        status_bars.config(
            text=
            f"Surge Productions \t\t\t\t\t characters: {chararcter} words: {word} \t\t\t\t Please Save Before You Run Your File - No Spaces\t\t"
        )
...
output_window = ScrolledText(window,
                             font=("corbel 12 bold"),
                             wrap=None,
                             height=9)
